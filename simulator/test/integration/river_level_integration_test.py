...
from src.models.raw_data.river_level_raw_data import RiverLevelRawData
...
def test() -> None:
    ...
    rawdata = RiverLevelRawData(value=25.0, latitude=0.0, longitude=0.0, sensor_uuid=UUID("123e4567-e89b-12d3-a456-426614174000"), sensor_name="sensor1")

    producer.produce(rawdata)

    client = Client(host="localhost", port=9000, user="admin", password="admin")
    query = "SELECT * FROM sensors.river_level"
