...
class TestEnvConfig(unittest.TestCase):
    ...
    def test_existing_envs(self) -> None:
        ...
        self.assertEqual(conf.__kafka_host, "host")
        self.assertEqual(conf.__kafka_portt, "1234")
        self.assertEqual(conf.__log_level, "INFO")
        self.assertEqual(conf.__max_block_ms, 2000)
    ...
    def test_default_values(self) -> None:
        ...
        self.assertEqual(conf.__max_block_ms, 1000)
